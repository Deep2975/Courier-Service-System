...
include "dbcon.php";
    ...
    $query = "select * from parcel where sname like '%{$search}%' or rcontact like '%{$search}%' or pnumber like '%{$search}%' or scontact like '%{$search}%' or rname like '%{$search}%' LIMIT {$limit}";
